...
<head>
  ...
  <style>
    ...
    header h1 {
      margin: 0;
      font-size: 2.5rem; /* Vikash Chopra */
    }

    header p {
      font-size: 1.1rem;
      margin-top: 0.3rem; /* Urbban Infrastructure */
    }
    ...
    nav {
      position: sticky;
      top: 0;
      border-Top: 5px solid #fdb813; /* Yellow Line */
      background: #003366;
      color: White;
      display: flex;
      padding: 0.1rem;
...
and earmarked the significance of ArcGIS Based Land suitability analysis in Development Plans
